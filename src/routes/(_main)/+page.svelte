...
<main>
	<div class="relative isolate overflow-hidden">
		...
		<div class="max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
			<div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
				...
				<p class="mt-6 text-lg leading-8 text-gray-300">
					When open source meets passion and curiosity, it unleashes the potential to evolve
					research, integrate technology and inform better care.
				</p>
	...
	<div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
		<div class="mx-auto max-w-2xl text-center">
			...
			<p class="mt-6 text-lg leading-8 text-gray-300">
				ChRIS reduces the barrier to cloud and distributed computing for researchers and developers.
				Re-use your existing code with minimal has quisquam.
			</p>
		</div>
		<div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
			<dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
				{#each primaryFeatures as feature (feature.name)}
					<div class="flex flex-col">
						<dt class="text-base font-semibold leading-7 text-white">
							<div class="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-500">
								<feature.icon class="h-6 w-6 text-white" aria-hidden="true" />
							</div>
							{feature.name}
						</dt>
						<dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-300">
							...
							<p class="mt-6">
								<a href={feature.href} class="text-sm font-semibold leading-6 text-indigo-400">
